package com.s4ltf1sh.glance_widgets.ui.theme
...
data class MonthCalendarColors(
    val background: ColorProvider,
    val weekDayTextColor: ColorProvider,
    val iconColor: ColorProvider,
    val dateTextColor: ColorProvider,
    val todayDateTextColor: ColorProvider,
    val unfocusedDateTextColor: ColorProvider,
...
internal val monthCalendarColors = MonthCalendarColors(
    ...
    unfocusedDateTextColor = ColorProvider(ColorLabelTextColor, ColorLabelTextColorNight),
